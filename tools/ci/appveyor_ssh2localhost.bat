...
appveyor DownloadFile https://github.com/PowerShell/Win32-OpenSSH/releases/download/v7.6.1.0p1-Beta/OpenSSH-Win32.zip -FileName C:\TMP\openssh.zip
7z x -o"C:\TMP" C:\TMP\openssh.zip
REM install
powershell.exe -ExecutionPolicy Bypass -File C:\TMP\OpenSSH-Win32\install-sshd.ps1
